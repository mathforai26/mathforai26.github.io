...
10. **References.** Put the ordinary reference list at the very end, after any
    appendices.
...
- Refer to exercises in active language that states their task, such as
  “Exercise 4 asks you to derive the formula,” rather than saying that a result
  “is derived in Exercise 4.”
...
- Retain the template's `enotez` setup and `\printendnotes`. Print the endnotes
  ...
  with links in both directions. Put the ordinary reference list after any
  appendices. Use unnumbered displays
