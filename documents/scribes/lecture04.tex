...
\newcommand{\lecturerevised}{2026-09-14 12:59 UTC-06:00}
\usepackage{eso-pic}
...
More examples create a second reason for finer optimization accuracy.
As the statistical error from a finite sample decreases, the
optimization error should decrease on the same scale if we are to
benefit fully from the additional data.
