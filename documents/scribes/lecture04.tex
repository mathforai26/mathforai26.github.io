...
material can be read separately. Numbered endnotes, bibliographical notes, the
glossary, exercises, appendices, and references follow the take-home
...
\input{../exercises/l4-multistep-benefit.tex}
\input{../exercises/l4-multistep.tex}
\input{../exercises/l4-kl-directions.tex}
\input{../exercises/l4-reverse-variational.tex}
\input{../exercises/l4-stability.tex}
\input{../exercises/l4-cumulative-recovery.tex}
