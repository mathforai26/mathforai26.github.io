...
\begin{tikzpicture}[
  ...
  \filldraw[typepanel] (0,0) rectangle (4.55,5.00);
  \node[typetitle] at (2.28,4.62) {Encoder-only};
  \node[typebox] (encin) at (2.28,0.65) {source tokens $x_{1:S}$};
  \node[typebox,fill=diagramgpt] (encstack) at (2.28,2.20)
    {encoder stack\\full self-attention};
  \node[typebox] (encout) at (2.28,3.65) {contextual source states};
  \draw[typeflow] (encin) -- (encstack);
  \draw[typeflow] (encstack) -- (encout);

  \begin{scope}[xshift=5.05cm]
    \filldraw[typepanel] (0,0) rectangle (4.55,5.00);
    \node[typetitle] at (2.28,4.62) {Decoder-only};
    \node[typebox] (decin) at (2.28,0.65) {single-sequence prefix $x_{<t}$};
    \node[typebox,fill=white!45!diagramllama] (decstack) at (2.28,2.20)
      {decoder stack\\causal self-attention};
    \node[typebox] (decout) at (2.28,3.65)
  ...
  \begin{scope}[xshift=10.10cm]
    \filldraw[typepanel] (0,0) rectangle (5.55,5.00);
    \node[typetitle] at (2.78,4.62) {Encoder--decoder};
    \node[typesmall] (srcin) at (1.25,0.65) {source $x_{1:S}$};
    \node[typesmall,fill=diagramgpt] (srcenc) at (1.25,2.20)
      {encoder\\full attention};
    \node[typesmall] (memory) at (1.25,3.65) {source memory};
    \node[typesmall] (tgtin) at (4.25,0.65) {target prefix $y_{<t}$};
    \node[typesmall,fill=white!45!diagramllama] (tgtdec) at (4.25,2.20)
      {decoder\\causal + cross-attention};
    \node[typesmall] (tgtout) at (4.25,3.65)
