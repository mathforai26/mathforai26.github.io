...
An encoder--decoder model is a probabilistic string-to-string map: each input
string determines a distribution over output strings. A decoder-only language
model is a probability distribution over strings. This supplement compares
